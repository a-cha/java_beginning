...
public class TransactionsLinkedList implements TransactionsList {
	...
	public void removeTransactionByID(String id) {
		TransactionsLinkedList.LinkedList iter = head;
		...
		throw new TransactionsLinkedList.TransactionNotFoundException("removeTransactionByID: no transaction with such id");
	}
	...
	static class TransactionNotFoundException extends RuntimeException {
		public TransactionNotFoundException(String m) { message = m; }
